...
cd "${0%/*}"
rm -f *.json || exit 1
./refresh-logs "https://mainnet.eos.dfuse.io/v0/search/transactions" || exit 1
...
./earnings-all "https://mainnet.eos.dfuse.io/v0/block_id/by_time" "https://mainnet.eos.dfuse.io/v0/state/table" alliance-b alliance-ek alliance-ek-plus alliance-support alliance-tgt || exit 1
