...
cd "${0%/*}"
rm -f *.json || exit 1
../earnings/refresh-logs "https://mainnet.wax.dfuse.io/v0/search/transactions" \
...
./refresh_log_ft "https://mainnet.wax.dfuse.io/graphql" || exit 1
../earnings/earnings-all prospectorsc "https://mainnet.wax.dfuse.io/v0/block_id/by_time" \
