...
const tableToSort = document.getElementById ('auction-history');
document.getElementById ('col-timestamp').addEventListener ('click', event =>
	{sortTable (tableToSort,  1 * 3, -1, 'str');});
document.getElementById ('col-type').addEventListener ('click', event =>
	{sortTable (tableToSort,  2 * 3, +1, 'str');});
document.getElementById ('col-owner').addEventListener ('click', event =>
	{sortTable (tableToSort,  4 * 3, +1, 'str');});
