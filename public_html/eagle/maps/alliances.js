...
const tableToSort = document.getElementById ('alliances-list');
document.getElementById ('col-alliance').addEventListener ('click', event =>
	{sortTable (tableToSort,  2 * 3, +1, 'str');});
document.getElementById ('col-plots').addEventListener ('click', event =>
	{sortTable (tableToSort,  3 * 3, -1, 'num');});
document.getElementById ('col-members').addEventListener ('click', event =>
...
document.getElementById ('col-stone').addEventListener ('click', event =>
	{sortTable (tableToSort,  6 * 3, -1, 'num');});
